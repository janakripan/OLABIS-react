          ...
          <div className="hero flex items-centere md:items-start md:justify-start w-full py-6 px-3 bg-[#F2EDEB]  max-w-[1500px] mx-auto
            ...
            <div className="flex flex-col items-center justify-center md:justify-normal py-14  md:items-start gap-y-6 md:w-1/2 z-50 ">
              ...
              <div className="buttons flex flex-row items-center gap-10">
                <button className=" whitespace-nowrap py-4  w-2/5 px-6 text-sm flex items-center justify-center hover:scale-105 hover:bg-red-700 transition-colors duration-300 text-white md:w-[170px] max-w-[170px] lg:text-xl  h-7 md:h-12 bg-[#EC0606] rounded-full ">
                  Get Started
                </button>

                <button className=" whitespace-nowrap flex flex-row items-center text-sm font-semibold text-[#EC0606] hover:text-red-500 md:w-full  lg:text-xl max-w-[180px]">
